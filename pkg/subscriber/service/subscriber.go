...
import (
	...
	"github.com/BrobridgeOrg/gravity-transmitter-kafka/pkg/app"
...
func (subscriber *Subscriber) Init() error {
	...
	err = subscriber.subscriber.Register(gravity_subscriber.SubscriberType_Transmitter, "kafka", subscriberID, subscriberName)
	if err != nil {
		return err
	}
